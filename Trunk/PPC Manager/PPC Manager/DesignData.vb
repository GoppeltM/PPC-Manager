...
Friend Class DesignSpielerListe
    ...
    Public Sub New()
        ...
        Add(New Spieler() With {.StartNummer = 5, .Vorname = "Leonardo", .Nachname = "Da Vinci", .TTRating = 5, .Geschlecht = 1})
        Add(New Spieler() With {.StartNummer = 6, .Vorname = "Sarah", .Nachname = "Palin", .TTRating = 6, .Geschlecht = 0})
        ...
        Add(New Spieler() With {.StartNummer = 24, .Vorname = "Napoleon", .Nachname = "Bonaparte", .TTRating = 24, .Geburtsjahr = 1790})
