...
Friend Class DesignSpielerListe
    ...
    Public Sub New()
        Dim spielverlauf = New DesignSpielverlauf
        Add(New Spieler("PLAYER01", spielverlauf) With {.Vorname = "Marius", .Nachname = "Goppelt", .TTRating = 1, .Geschlecht = 1})
        Add(New Spieler("PLAYER02", spielverlauf) With {.Vorname = "Flo", .Nachname = "Ewald", .TTRating = 2})
        Add(New Spieler("PLAYER03", spielverlauf) With {.Vorname = "Hartmut", .Nachname = "Seiter", .TTRating = 3})
        Add(New Spieler("PLAYER04", spielverlauf) With {.Vorname = "Max", .Nachname = "Mustermann", .Vereinsname = "TTC Langensteinbach", .TTRating = 4})
        Add(New Spieler("PLAYER05", spielverlauf) With {.Vorname = "Leonardo", .Nachname = "Da Vinci", .TTRating = 5, .Geschlecht = 1})
        Add(New Spieler("PLAYER06", spielverlauf) With {.Vorname = "Sarah", .Nachname = "Palin", .TTRating = 6, .Geschlecht = 0})
        Add(New Spieler("PLAYER07", spielverlauf) With {.Vorname = "Manuel José", .Nachname = "Barroso", .TTRating = 7})
        Add(New Spieler("PLAYER08", spielverlauf) With {.Vorname = "Catharina", .Nachname = "Sforza", .TTRating = 8})
        Add(New Spieler("PLAYER09", spielverlauf) With {.Vorname = "Adam", .Nachname = "Jensen", .TTRating = 9})
        Add(New Spieler("PLAYER10", spielverlauf) With {.Vorname = "Miroslav", .Nachname = "Klose", .TTRating = 10})
        Add(New Spieler("PLAYER11", spielverlauf) With {.Vorname = "Che", .Nachname = "Guevara", .TTRating = 11})
        Add(New Spieler("PLAYER12", spielverlauf) With {.Vorname = "Friedrich", .Nachname = "Nietzsche", .TTRating = 12})
        Add(New Spieler("PLAYER13", spielverlauf) With {.Vorname = "Johann Wolfgang von", .Nachname = "Goethe", .TTRating = 13})
        Add(New Spieler("PLAYER14", spielverlauf) With {.Vorname = "Margaret", .Nachname = "Thatcher", .TTRating = 14})
        Add(New Spieler("PLAYER15", spielverlauf) With {.Vorname = "Marie", .Nachname = "Curie", .TTRating = 15})
        Add(New Spieler("PLAYER16", spielverlauf) With {.Vorname = "Albert", .Nachname = "Einstein", .TTRating = 16})
        Add(New Spieler("PLAYER17", spielverlauf) With {.Vorname = "Julius", .Nachname = "Cäsar", .TTRating = 17})
        Add(New Spieler("PLAYER18", spielverlauf) With {.Vorname = "Lucius", .Nachname = "Verenus", .TTRating = 18})
        Add(New Spieler("PLAYER19", spielverlauf) With {.Vorname = "Titus", .Nachname = "Pullo", .TTRating = 19})
        Add(New Spieler("PLAYER20", spielverlauf) With {.Vorname = "Mick", .Nachname = "Jagger", .TTRating = 20})
        Add(New Spieler("PLAYER21", spielverlauf) With {.Vorname = "Paul", .Nachname = "Ryan", .TTRating = 21})
        Add(New Spieler("PLAYER22", spielverlauf) With {.Vorname = "Barack", .Nachname = "Obama", .TTRating = 22})
        Add(New Spieler("PLAYER23", spielverlauf) With {.Vorname = "Francois", .Nachname = "Mitterrand", .Vereinsname = "TTC Langensteinbach", .TTRating = 23})
        Add(New Spieler("PLAYER24", spielverlauf) With {.Vorname = "Napoleon", .Nachname = "Bonaparte", .TTRating = 24, .Geburtsjahr = 1790})
        Add(New Spieler("PLAYER25", spielverlauf) With {.Vorname = "Marty", .Nachname = "McFly", .TTRating = 25})
        Add(New Spieler("PLAYER26", spielverlauf) With {.Vorname = "Marilyn", .Nachname = "Monroe", .TTRating = 26})
        Add(New Spieler("PLAYER27", spielverlauf) With {.Vorname = "Freddy", .Nachname = "Mercury", .TTRating = 27})
        Add(New Spieler("PLAYER28", spielverlauf) With {.Vorname = "Stephen", .Nachname = "Hawking", .TTRating = 28})
    End Sub
End Class
