Public Class PaarungssucheTests
    ...
    Sub Gerade_StandardPaarung_hat_keinen_Schwimmer()
        ...
        Dim suche = New PaarungsSuche(Of Integer)(Function(a, b) a.CompareTo(b), Function(a, b) False).SuchePaarungen(Function(x) False, l, True)
    ...
    Sub Wer_bereits_gegeneinander_gespielt_hat_spielt_nicht_erneut()
        ...
        Dim habenGespielt = Function(x As Integer, y As Integer) As Boolean
                                ...
                                Return False
                            End Function
        Dim suche = New PaarungsSuche(Of Integer)(Function(a, b) a.CompareTo(b), habenGespielt).SuchePaarungen(Function(x) False, l, True)
    ...
    Sub Keine_Paarung_wenn_alle_möglichen_Schwimmer_Altschwimmer_sind()
        ...
        Dim altSchwimmer = Function(x As Integer) As Boolean
                               ...
                               Return False
                           End Function
        Dim suche = New PaarungsSuche(Of Integer)(Function(a, b) a.CompareTo(b), habenGespielt).SuchePaarungen(altSchwimmer, l, True)
    ...
    Sub Kein_Ergebnis_wenn_ungerades_Paket_nur_Altschwimmer_hat()
        Dim l = {5, 4, 3, 2, 1}
        Dim suche = New PaarungsSuche(Of Integer)(Function(a, b) a.CompareTo(b), Function(x, y) False).SuchePaarungen(Function(x) True, l, True)
        Assert.That(suche, Iz.Null)
    End Sub
    ...
    Sub Letzter_Spieler_ist_nicht_Schwimmer_wenn_er_Altschwimmer_ist()
        Dim l = {5, 4, 3, 2, 1}
        Dim suche = New PaarungsSuche(Of Integer)(Function(a, b) a.CompareTo(b), Function(x, y) False).SuchePaarungen(Function(x) x = 1, l, True)
